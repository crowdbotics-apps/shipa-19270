...
admin.site.site_header = "shipa"
admin.site.site_title = "shipa Admin Portal"
admin.site.index_title = "shipa Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="shipa API",
        default_version="v1",
        description="API documentation for shipa App",
    ),
    public=True,
